//1. Допилить пирамиду, чтоб там было +3 картинки в «хвосте» у каждой октавы
//2. Посчитать разности для всех октав
//3. По всем этим разностям поискать экстремумы, с хорошим харрисом в исходной пирамиде.
//4. Использовать полученные точки и их масштабы, чтобы построить дескрипторы
